        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group mb-3">
                            <span class="input-group-prepend"><span class="input-group-text" style="color:#2196F3";><i class="fas fa-briefcase"></i></span></span>
                            <label for="input-select"></label>
                            <select class="form-control" id="input-select" name="profession">
                                <option value="">Profession</option>
                                @foreach ($professions as $profession)
                                    @if (Session::get('profession') == $profession)
                ...
                <div class="form-group pt-2 text-center">
                    <button class="btn btn-block btn-primary" type="submit">Register My Personal Account</button>
                </div>
